...
Ключ устанавливается в конструкторе, а также с помощью метода set\+\_\+key. Для зашифрования и расшифрования используются методы encrypt и decrypt. Метод set\+\_\+tableform -\/ вспомогающий. Методы\+: get\+Valid\+Key, get\+Valid\+Open\+Text, get\+Valid\+Cipher\+Text -\/ специализируются на проверке входных данных. \begin{DoxyWarning}{Предупреждения}
Реализация только для русского языка. С использованием wstring. Шифрование табличной перестановкой 
\end{DoxyWarning}
...
Конструктор, который принимает на вход ключ, устанавливает кол-\/во столбцов
...
метод проверяет зашифрованный текст на правильность.
...
Метод проверяет ключ на правильность.
...
Метод проверяет открытый текст на правильность. Строчные буквы становятся прописными. Все не-\/буквы удаляются.
...
Метод, который принимает на вход ключ, устанавливает кол-\/во столбцов
